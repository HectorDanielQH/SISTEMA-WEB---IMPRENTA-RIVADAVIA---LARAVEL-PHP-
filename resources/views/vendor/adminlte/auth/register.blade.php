...
@section('auth_header', __('Nuevo Miembro'))
    ...
    <form action="{{ $register_url }}" method="post">
        ...
        <div class="input-group mb-3">
            <input type="number" name="ci" class="form-control {{ $errors->has('ci') ? 'is-invalid' : '' }}"
                   value="{{ old('ci') }}" placeholder="{{ __('Carnet de Identidad') }}" autofocus>
        ...
        <div class="input-group mb-3">
            <input type="text" name="apellidos" class="form-control {{ $errors->has('apellidos') ? 'is-invalid' : '' }}"
                   value="{{ old('apellidos') }}" placeholder="{{ __('Apellidos') }}" autofocus>
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-user {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
        ...
        <div class="input-group mb-3">
            <input type="password" name="password_confirmation"
                   ...
                   placeholder="{{ __('Repetir Password') }}">
            <div class="input-group-append">
                <div class="input-group-text">
                    <span class="fas fa-lock {{ config('adminlte.classes_auth_icon', '') }}"></span>
                </div>
